...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 75d8087b-f066-4647-a631-e9c9d78b6d79
```

> `75d8087b-f066-4647-a631-e9c9d78b6d79` is the password of the certificate, you can change it to any password you want.
